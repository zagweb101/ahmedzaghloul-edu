...
Route::get('/live-events/{liveEvent:slug}', [LiveEventController::class, 'show'])->name('live-events.show');
Route::get('/subscription-plans', [SubscriptionPlanController::class, 'index'])->name('subscription-plans.index');
Route::get('/subscription-plans/{subscriptionPlan:slug}', [SubscriptionPlanController::class, 'show'])->name('subscription-plans.show');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/live-events/{liveEvent:slug}/register', [LiveEventController::class, 'register'])->name('live-events.register');
    Route::delete('/live-events/{liveEvent:slug}/register', [LiveEventController::class, 'cancel'])->name('live-events.cancel');
